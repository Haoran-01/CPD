      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-6 col-12">
          <HorizontalTeamCard
            ...
            Also has the ability of data analysis and feature engineering, and is able to customise algorithmic strategies according to different dataset requirements."
          />
        </div>
      </div>
    </div>
